...
<head>
    ...
    <style>
        ...
        :root{--txt-blue-color:#1F51FF;--txt-white-color:#ffffff;--txt-secondary-color:#949494}i{font-size:.75rem}body{margin:0;padding:0;font-family:Inter,sans-serif;background:#111;color:#fff}::-webkit-scrollbar{width:2px;height:2px}::-webkit-scrollbar-track{background-color:var(--txt-secondary-color)}::-webkit-scrollbar-thumb{background:#1163d2;border-radius:10px}::-webkit-scrollbar-thumb:hover{background:var(--txt-blue-color)}section{max-width:1200px;height:90vh;margin:80px auto 0;display:grid;grid-template-columns:1fr 4fr;padding:20px 30px;box-sizing:border-box}div.menu-bar-icon{position:absolute;top:10px;right:10px;display:none}div.menu-bar-icon>i{font-size:2rem}@media screen and (max-width:1130px){section{grid-template-columns:2fr 6fr}}section>div.left-side{grid-column:1;width:250px;position:relative}section>div.left-side div.mobile-menu-close{display:none}@media screen and (max-width:780px){div.menu-bar-icon,section{display:block}section{padding:20px 0}section>div.left-side{display:none}section>div.left-side>nav>div.category{border-left:none!important}section>div.right-side{padding:0 15px!important}}section>div.left-side.mobile{display:block;position:fixed;border-right:1px solid rgba(255,255,255,.1);padding:20px;top:0;z-index:999;width:0;background:#111;height:100%;opacity:0;visibility:hidden;pointer-events:none;transition:width .5s,opacity .5s,visibility .5s}section>div.left-side.mobile-active{width:250px;opacity:1;visibility:visible;pointer-events:auto}section>div.left-side.mobile div.mobile-menu-close{display:block;position:absolute;right:15px;top:15px}section>div.left-side div.mobile-menu-close i{font-size:20pt}section>div.left-side>nav>p.category-heading{font-size:14pt;margin:20px 0}section>div.left-side>nav>p.category-heading:hover{cursor:pointer}section>div.left-side>nav>div.category{padding:0 30px;border-left:2px solid var(--txt-secondary-color)}section>div.left-side>nav>div.category[a.active]{border-left:2px solid var(--txt-blue-color)}section>div.left-side>nav>div.category a{text-decoration:none;color:var(--txt-secondary-color);font-size:.875rem;padding:13px 0;display:flex;justify-content:space-between;align-items:center}section>div.left-side>nav>div.category a.sub-category-holder{color:var(--txt-white-color)}section>div.left-side>nav>div.category a.active{color:var(--txt-blue-color)}section>div.left-side>nav>div.category a:hover{color:var(--txt-white-color);cursor:pointer}section>div.left-side>nav>div.category a>i{transition:transform .3s}section>div.left-side>nav>div.category a>i.rotate{transform:rotate(180deg)}section>div.left-side>nav>div.category>a.open>i.fa-chevron-right{transform:rotate(90deg)}section>div.left-side>nav>div.category>div.sub-category{opacity:0;max-height:0;padding:0 0 0 12px;pointer-events:none;transition:.5s}section>div.left-side>nav>div.category>div.sub-category.active{opacity:1;max-height:400px;pointer-events:auto}section>div.left-side>nav>div.category>div.sub-category>div.sub-category-content{border-left:2px solid var(--txt-secondary-color);padding:0 11px}section>div.right-side{grid-column:2/span 1;padding:0 40px;overflow-y:auto;font-size:.9rem}section>div.right-side>div{display:none;opacity:0}@-webkit-keyframes fadeIn{from{opacity:0}to{opacity:1}}@keyframes fadeIn{from{opacity:0}to{opacity:1}}section>div.right-side>div.active{display:block;-webkit-animation:.8s fadeIn;animation:.8s fadeIn;opacity:1}section>div.right-side h1{text-align:center;margin-bottom:3.5rem}section>div.right-side div.content-group{padding:0 5px}section>div.right-side div.content-group>.content-title{font-size:1.5rem;padding-bottom:10px}section>div.right-side ul{padding-inline-start:30px!important}section>div.right-side ul>li{margin:15px 0}
    </style>

    <!-- Predefined css class -->
    <style>.sub-heading-1{font-size:4rem}.sub-heading-2{font-size:2rem}.sub-heading-3{font-size:1.5rem}.sub-heading-4,.table th{font-size:1rem}.separate-content{width:96%;margin:40px auto;border:none;height:1px;background-color:var(--txt-secondary-color);opacity:.5}.link{color:var(--txt-blue-color);text-decoration:none}.link:hover{cursor:pointer}.content{line-height:1.5rem}.text-center{text-align:center}.text-bold{font-weight:700}.border-blue{border-left:2px solid var(--txt-blue-color)!important}pre{background:#1e2123;border:1px solid rgba(255,255,255,.2);border-radius:10px!important}.code-box{background:0 0;font-family:"JetBrains Mono",monospace;font-size:13px}.code-box::-webkit-scrollbar{display:none}.table{border-collapse:separate;border-spacing:0;width:100%;margin:20px 0;border-radius:7px!important;overflow:hidden}.method,.return-type{padding:5px;margin:5px 2px;line-height:30px}.table,.table td,.table th{border:1px solid rgba(255,255,255,.2)}.table th,.table tr:last-child td{border-bottom:none}.table th{background-color:#48484d;padding:10px 0;font-weight:400}.table td{padding:10px 15px}.table td:first-child,.table th:first-child{border-left:none}.table td:last-child,.table th:last-child{border-right:none}.table tr:first-child th{border-top:none}.table tr td:first-child{white-space:nowrap}@media screen and (max-width:1150px){.table.request tr td:first-child{white-space:normal}}.table tr td:nth-child(2){line-height:30px}.method{background-color:rgba(255,255,255,.2);border-radius:8px;font-size:.8rem}.return-type{background-color:var(--txt-blue-color);border-radius:6px}.language-identify{padding:20px!important;background:#111;border-top-left-radius:10px;border-top-right-radius:10px;display:flex;justify-content:space-between;align-items:center;font-family:Inter,sans-serif}.language-identify>div{display:flex;align-items:center;gap:5px}.language-identify i{font-size:15pt}.language-identify i.fa-terminal{font-size:9pt}</style>
</head>
...
Route::get("user/{credential, :regex(^\d+$)}", [\App\HTTP\Controllers\User::class, "index"]);
    ...
    <script>const holders=document.querySelectorAll(".sub-category-holder"),links=document.querySelectorAll(".category a"),blocks=document.querySelectorAll(".right-side div"),menu=document.getElementById("menu"),leftSide=document.getElementById("left-side"),menuClose=document.getElementById("menu-close");document.addEventListener("DOMContentLoaded",()=>{hljs.highlightAll();let e=()=>{let e=document.querySelector("nav");e.classList.remove("mobile"),e.classList.remove("desktop"),window.innerWidth<780?(leftSide.classList.add("mobile"),e.classList.add("mobile")):(leftSide.classList.remove("mobile"),e.classList.add("desktop"))};e(),window.addEventListener("resize",e),menu.addEventListener("click",()=>{leftSide.classList.toggle("mobile-active")}),menuClose.addEventListener("click",()=>{leftSide.classList.remove("mobile-active")}),blocks.forEach(e=>{e.classList.remove("active"),(""===window.location.hash||"#home"===window.location.hash)&&document.getElementById("home").classList.add("active"),""!==window.location.hash&&document.getElementById(window.location.hash.substring(1)).classList.add("active")}),holders.length>0&&holders.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault(),e.classList.toggle("open");let s=e.nextElementSibling;s&&s.classList.contains("sub-category")&&s.classList.toggle("active")})});let t=e=>{if(links.forEach(e=>{e.classList.remove("active");let t=e.closest(".category");t&&t.classList.remove("border-blue");let s=e.closest(".sub-category-content");s&&s.classList.remove("border-blue");let l=e.querySelector("i");l&&l.classList.remove("rotate")}),e){e.classList.add("active");let t=e.closest(".category");t&&t.classList.add("border-blue");let s=e.closest(".sub-category-content");s&&s.classList.add("border-blue");let l=e.querySelector("i");l&&l.classList.add("rotate")}},s=e=>{if(e){let t=new URL(e),s=t.hash.substring(1),l=document.getElementById(s)??null;null!==l&&l.classList.add("active")}};links.length>0&&links.forEach(e=>{e.addEventListener("click",()=>{e.classList.contains("sub-category-holder")||(blocks.forEach(e=>{e.classList.remove("active")}),t(e),s(e.href))}),window.location.href!==e.href||e.classList.contains("active")||t(e)})});</script>
</body>
</html>
