...
<head>
    ...
    <!-- Framework icon -->
    <link rel="icon" href="<?php echo ExceptionDisplay::getBaseUrl('/nova_icon/novaframe.header'); ?>">
...
<div class="logo-box">
    ...
    <img src="<?php echo ExceptionDisplay::getBaseUrl('nova_icon/novaframe'); ?>" alt="Framework Logo">
</div>
</body>
</html>
